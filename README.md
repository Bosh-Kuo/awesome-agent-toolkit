...
| **Product PRD**                 | Generate a high-level Product Requirements Document (PRD) for a new product or project at inception stage. Focuses on vision, objectives, personas, and roadmap.                                     | [Skill](./skills/product-prd)                 | [Personal Collection](https://github.com/Bosh-Kuo/awesome-agent-toolkit)                     | 2026-03-27      |
| **shadcn**                      | Manages shadcn components and projects — adding, searching, fixing, debugging, styling, and composing UI. Provides project context, component docs, and usage examples.                          | [Skill](./skills/shadcn)                      | [Official Site](https://ui.shadcn.com/docs/skills)                                           | 2026-03-27      |

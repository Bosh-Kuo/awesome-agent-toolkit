...
| **Frontend Design**             | Create distinctive, production-grade frontend interfaces that avoid generic AI aesthetics, with guidelines for typography, color (OKLCH), layout, motion, and interaction.                           | [Skill](./skills/frontend-design)             | [GitHub](https://github.com/pbakaus/impeccable/tree/main/source/skills/frontend-design)      | 2026-03-18      |
